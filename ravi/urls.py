...
urlpatterns = [
  ...
  # Home basic detail
    ...
    path('getApprovedRecords/<str:refCode>',CustomerViewSet.as_view({"get":"getApprovedRecords"}),name="get-HomeApprovedRecords"),
    path('getRejectedRecords/<str:refCode>',CustomerViewSet.as_view({"get":"getRejectedRecords"}),name="homegetRejectedRecords"),
